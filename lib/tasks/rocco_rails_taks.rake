...
begin
  ...
  Rocco::make 'docs/', ["app/models/*.rb", "app/controllers/*.rb"], {:template_file => template, :stylesheet => RoccoRails.generate_resources(resources_path, [Rails.root.to_s, out, "resources"].join("/")) }
